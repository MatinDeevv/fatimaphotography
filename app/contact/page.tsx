...
export default function Booking() {
  ...
  return (
    ...
    >
      ...
      <nav className="bg-white bg-opacity-80 shadow-md fixed top-0 w-full z-50">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          ...
          >
            ...
            <li><Link href="/booking" className="text-gray-800 hover:text-blue-600">Booking</Link></li>
          </ul>
        </div>
      </nav>
      ...
      >
        <h2 className="text-2xl text-black font-semibold text-center mb-6">Book Your Session</h2>
        ...
        <div className="mb-4">
          <label className="block text-sm font-medium mb-1 text-gray-700">Venue Location</label>
          <input
            type="text"
            name="venue"
        ...
        <div className="mb-4">
          <label className="block text-sm font-medium mb-1 text-gray-700">Referral</label>
          <input
            type="text"
            name="referral"
        ...
        <div className="flex items-center mb-4">
          ...
          />
          <label className="text-sm text-gray-700">Sign me up for the newsletter!</label>
        </div>
