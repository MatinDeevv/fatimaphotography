...
const services = [
  {
    ...
    description:
      'Creative and professional portrait sessions that bring out the best in every individual.',
  ...
  },
  {
    ...
    description:
      'Immortalize every magical moment of your wedding with our artistic wedding photography.',
  ...
  },
  {
    ...
    description:
      'Celebrate your journey together with timeless engagement photos that tell your unique story.',
  ...
  },
  {
    ...
    description:
      'We offer a range of photography services tailored to your needs.',
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen py-16 relative">
      <h1 className="text-5xl font-bold text-center mb-16">
        Our Unique Photography Services
      </h1>
