    ...
    <>
      ...
      <main className="bg-gray-100 text-gray-800">
            ...
            {['Weddings', 'Portraits', 'Events', 'Fashion', 'Nature'].map((service, idx) => (
              ...
              >
                ...
                <p className="text-gray-700">
                  Capture the essence of your special moments with professional{' '}
                  {service.toLowerCase()} photography.
                </p>
              </div>
            ))}
          </div>
        ...
        <section className="py-16 px-6 bg-gray-50">
          ...
          <Swiper autoplay={{ delay: 5000 }} loop spaceBetween={30} className="max-w-5xl mx-auto">
            {[
              {
              ...
              },
              {
                name: 'Alice Johnson',
                date: '10/03/2023',
                review: 'Amazing photos! The team captured every special moment beautifully.',
                rating: 5,
              ...
              },
              {
                name: 'Bob Smith',
                date: '01/02/2023',
                review: 'Captured everything perfectly! Highly professional and friendly team.',
                rating: 4.5,
                avatar: 'https://via.placeholder.com/50',
                googleLogo:
                  'https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Google_2015_logo.svg/512px-Google_2015_logo.svg.png',
